    ...
    <div class="ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle text-light" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <h5 class="text-light" style="margin-right: 10px">{{Auth::guard('pere')->user()->nom}} {{Auth::guard('pere')->user()->prenom}}</h5>
          <img class="img-profile rounded-circle" src="{{asset('storage/' . Auth::guard('pere')->user()->image)}}" style="width: 40px; height:40px;">
        </a>
        <!-- Dropdown - User Information -->
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
          <a class="dropdown-item" href="/Parprofile">
