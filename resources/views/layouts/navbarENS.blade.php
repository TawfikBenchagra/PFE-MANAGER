      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle text-light" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <h5 class="text-light" style="margin-right: 10px">
            {{Auth::guard('enseignant')->user()->nom}} 
            {{Auth::guard('enseignant')->user()->prenom}}
          </h5>
          <img class="img-profile rounded-circle" src="{{asset('storage/' . Auth::guard('enseignant')->user()->image)}}" style="width: 40px; height:40px;">
        </a>
