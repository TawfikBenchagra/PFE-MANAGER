...
<head>
    ...
    <title>E-APPR | Connecter Parent</title>
            ...
            <div class="col-12 col-sm-8 col-md-5 m-auto mt-5">
                <div class="card border-0 shadow rounded-1">
                    <div class="card-body">
                        ...
                        <form action="{{route('connectPar')}}" method="POST">
                            @csrf
                            @error('email')
                            ...
                            <input type="text" name="apogee_etd" class="form-control my-3 py-2 rounded-5 shadow-lg p-3" placeholder="Apogee de votre fils (fille)" value="{{old('apogee')}}" required>
                            ...
                            <div class="text-center mt-4">
                                <button class="btn text-light rounded-1" style="background-color: #4e57d4;">Se connecter</button>
                            </div>
                        </form>
                    </div>
                </div>
