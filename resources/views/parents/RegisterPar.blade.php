...
<head>
    ...
    <title>E-APPR | Inscrire Parent</title>
            ...
            <div class="col-12 col-sm-9 col-md-6 m-auto mt-2 mb-2 rounded-1">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <form action="{{route('storePar')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            @enderror
                            <input type="text" class="form-control my-3 py-2 rounded-5 shadow-lg p-3" name="apogee_etd" placeholder="Apogee de votre fils (fille)" value="{{old('apogee')}}" required>
                            @error('apogee_etd')
                                <div class="alert alert-danger" role="alert">{{$message}}</div>
                            @enderror
