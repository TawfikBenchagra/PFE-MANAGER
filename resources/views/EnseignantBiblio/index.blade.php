...
@section('contents')
    <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('Ensbibliotheque.create') }}" class="btn btn-success">Ajouter un fichier</a>
    </div>
    <!-- ajouter la possibilite -->
    <form action="{{ route('Ensbibliotheque.index') }}" method="GET">
        <div class="row">
            <div class="col-md-4">
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="{{ route('Ensbibliotheque.edit', $rs->id)}}" type="button" class="btn btn-warning">Edit</a>
                                <a href="{{ route('Ensbibliotheque.show', $rs->id)}}" type="button" class="btn btn-info">Show</a>
                                <form action="{{ route('Ensbibliotheque.destroy', $rs->id) }}" method="POST" type="button" class="btn btn-danger p-0" onsubmit="return confirm('Delete?')">
                                    @csrf
                                    @method('DELETE')
