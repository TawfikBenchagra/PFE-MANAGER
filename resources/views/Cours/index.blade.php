...
@section('contents')
    <div class="d-flex align-items-center justify-content-between ms-3 me-3">
        ...
        <a href="{{ route('cours.create') }}" class="btn btn-success">Ajouter un PFE</a>
    </div>
    <hr>
    ...
    <form action="{{route('showCoursEns')}}" method="get">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-4">
                <div class="card mt-3 display-inline" style="width: 16rem; height: 23rem; margin-left: 15px;">
                    ...
                    <div class="row">
                        <a href="{{route('meeting')}}" class="btn btn-primary" style="margin-left:3px">Voir plus</a>
                        <form action="{{route('cours.destroy', $item->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger" style="margin-left: 40px">Supprimer</button>
                        </form>
                    </div>
                    </div>
                </div>
