...
class EnsEmploisController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('Emplois.Enseignant.index', compact('timetable', 'filieres', 'semestres'));
    }
    ...
    public function create()
    {
        ...
        return view('Emplois.Enseignant.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $emploi->save();
        return redirect()->route('EnsEmplois.index')->with('success', 'Emploi du temps créé avec succès.');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('Emplois.Enseignant.edit', compact('timetable'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('EnsEmplois.index')
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('EnsEmplois.index')->with('success', 'Seance deleted successfully');
    }
}